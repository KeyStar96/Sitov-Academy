...
export const VIDEO_FALLBACKS = {
  ...
  external_privacy: "YouTube wird erst geöffnet, wenn du einen Videolink anklickst. Es werden hier keine YouTube-Player oder Vorschaubilder geladen.",
  cms_title: "Lernvideos verwalten",
  cms_subtitle: "Veröffentliche den YouTube-Link, sobald ein Video fertig ist. Lernvideos ergänzen die drei Trainer.",
  ...
  cms_legacy: "Älterer Eintrag – ergänze einen YouTube-Link, um ihn im Lernraum anzuzeigen.",
