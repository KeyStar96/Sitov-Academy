...
export default function PronunciationInbox({ conversations, lang, translations, staff = false }: { conversations: Conversation[]; lang: string; translations: PronunciationTranslations; staff?: boolean }) {
