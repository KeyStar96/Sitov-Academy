...
export default function VocabCMS({ initialData }: { initialData: VocabularyCardRow[] }) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const parsed = vocabWriteSchema.safeParse(form)
