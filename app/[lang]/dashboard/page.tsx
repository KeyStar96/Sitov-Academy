...
export default async function DashboardPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return <div className="academy-dashboard">
    <div className="academy-dashboard-intro"><div><p className="academy-eyebrow">{copy.dashboard_eyebrow}</p><h1>{copy.dashboard_title}</h1><p>{copy.dashboard_description}</p></div><Link className="academy-button academy-button-outline" href={`/${lang}/dashboard/profile`}>{copy.dashboard_profile}<ArrowUpRight size={18} aria-hidden="true" /></Link></div>
