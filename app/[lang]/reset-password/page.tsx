      ...
      {hasRecoverySession ? (
        ...
        <div className="space-y-5">
          ...
          <Link
            ...
            className="flex min-h-14 w-full items-center justify-center rounded-2xl bg-[var(--accent)] px-6 text-xl font-bold text-[var(--accent-foreground)] shadow-md transition-colors hover:bg-[var(--accent-hover)] focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-2 focus-visible:outline-[var(--violet)]"
          >
            {t('forgot_submit')}
          </Link>
