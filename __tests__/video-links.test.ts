import { videoInputSchema, youtubeWatchUrl } from '@/lib/video-links'
...
describe('YouTube learning links', () => {
  ...
  it('requires a supported course level and a real watch URL before teacher publication', () => {
    const input={level:'A1.1',title:'Begrüßung',lesson:'01',description:'',external_url:'https://youtu.be/abcdefghijk'}
    ...
    expect(videoInputSchema.safeParse({...input,external_url:'https://example.com/video'}).success).toBe(false)
  })
})
