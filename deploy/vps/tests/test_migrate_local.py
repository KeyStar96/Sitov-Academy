...
class MigrationFailureTests(unittest.TestCase):
    ...
    def test_content_quality_migration_precedes_phase4_and_waits_for_matching_app(self):
        self.assertEqual(MIGRATION.ORDER[-5:], ['06_soft_errors.sql', '07_content_quality.sql', '08_performance_indexes.sql', '09_progress_aggregate.sql', '10_rls_performance.sql'])
