...
class MigrationFailureTests(unittest.TestCase):
    ...
    def test_content_quality_migration_precedes_phase4_and_waits_for_matching_app(self):
        self.assertEqual(MIGRATION.ORDER[-10:], ['06_soft_errors.sql', '07_content_quality.sql', '08_performance_indexes.sql', '09_progress_aggregate.sql', '10_rls_performance.sql', '11_teacher_analytics.sql', '12_media_upload.sql', '13_mail_exception_kind.sql', '14_mail_exceptions.sql', '15_grading_helper_permissions.sql'])
