...
Der live geprüfte Kurskatalog enthält zehn aktive und zwei archivierte Kurse; Anlegen, Bearbeiten und Archivieren wurden im Browser geprüft. Der technische Umbau führt kein neues Tarifmodell ein. Ein zentrales schwarzes Brett dient der Betreuung. Ein öffentlich eingegebener E-Mail-Wert berechtigt niemals zur Anzeige bestehender Personen- oder Buchungsdaten; eine Zusammenführung setzt eine verifizierte Auth-Identität und eindeutige Zuordnung voraus. 22 Live-REST-Prüfgruppen bestanden, darunter NULL-Eingaben und fachliche Revisionskonflikte ohne unerwünschte Datenänderung.

Anwendung, Datenbank, Storage, Mail-Outbox und Sprachsynthese laufen auf dem eigenen VPS unter [https://217.154.228.254](https://217.154.228.254) mit geprüftem IP-TLS. Für die neuen Lern-/Buchungsabläufe ist kein Cloud-Supabase-, Resend-, Upstash- oder externer Sprachdienst erforderlich. Die erlaubte lesende Cloud-Orientierung wurde nicht genutzt. Lokale Auth-Zustellung mit bestätigtem Token und ein nativer Outbox-Worker-Lauf bis `sent` sind nachgewiesen; externe Testmails wurden nicht versendet. Der regelmäßige Mailworker ist aktiviert und läuft unter systemd. Daraus werden keine Einsparbeträge oder allgemeinen Zustellgarantien abgeleitet. Stripe-Beschreibungen im historischen Teil sind kein aktiver Abrechnungs- oder Freigabevertrag des neuen Systems.

Der freigegebene Schüler-Neustart nach vollständigem, wiederherstellbar geprüftem Backup wurde als einmalige Migration ausgeführt; zwei Staff-Konten und der Unterrichtskatalog blieben erhalten. Der reguläre Lernreset lässt Personen, Buchungen und Rechnungsvorgänge bestehen. Testkonten, Testbuchungen und Testaufnahmen sind nach zusätzlicher Sicherung entfernt; die letzte Chat-Bereitstellung ist live bestätigt. [Fachliches Modell, Sicherung und belegter Prüfstand](docs/vps-refactor-2026-09-13.md).
