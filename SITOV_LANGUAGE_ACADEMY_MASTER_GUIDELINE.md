...
## Aktuelle verbindliche Leitlinien — kanonisches VPS-Schema

Das bestehende warme Design, Light/Darkmode, hoher Kontrast, lesbare Trainingskarten und die Audio-Waveform bleiben erhalten. Die Plattform verwendet feste relationale Freigaben pro Niveau, Trainer und UUID-Einheit. Schüler mit deutscher Interface-Sprache erhalten keinen Trainerzugriff; der deutsche Lehrerbereich bleibt für die Verwaltung erreichbar.

Alle 512 Vokabelkarten, 604 Grammatikübungen und 149 Aussprachetexte bleiben erhalten. Die sechs aktiven Teilniveaus haben weiterhin je zehn aktive Lesetexte; weitere erhaltene Texte bleiben im CMS bearbeitbar. B2/C1/C2 sind inaktive CEFR-Familien mit festen Einheiten, keine frei schwebenden Altdaten. Aussprache bleibt ein Dialog mit zusammenhängenden Texten, Aufnahme, Waveform und Lehrer-/Schülerantworten. Vokabeln werden in beiden Sprachrichtungen mit getrenntem Fortschritt gelernt.

Der Katalog enthält neun Kurse. Privatunterricht Online bekommt ein klar beschriftetes Mengenfeld mit Plus/Minus und direkter Eingabe, sichtbarem Stückpreis und sofortiger Summe. Buchungsbestätigungen zeigen Anzahl, Dauer und Preis. Keine unsichtbaren Ersatzzeichen in Notizen, keine Rabattnebenfelder, keine doppelten Video-URL-/Providerfelder und keine Kompatibilitäts-Views im aktuellen Modell.

Neue Schüler beginnen ohne Niveauzugang. Verifizierte Identität und RLS schützen personenbezogene Daten. Lokale Supabase, Postfix und TTS bleiben auf dem VPS; keine DNS-Änderung. [Katalog, Schema, Sicherung und tatsächliche Prüfergebnisse](docs/canonical-schema-2026-09-13.md).
