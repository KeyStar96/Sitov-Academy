...
**Der normalisierte Lern- und Verwaltungsaufbau ist live angewendet und in zentralen Browserabläufen geprüft.** Der Markenname bleibt überall **Sitov Academy**. Das bestehende ruhige Design, gut lesbare Lerntexte, große Bedienflächen, Waveforms sowie Hell/Dunkel mit unabhängigem Hochkontrastmodus bleiben erhalten.
...
- Grammatiklektionen und Aussprachetexte brauchen klare Namen. Die Freigabeverwaltung öffnet einen begrenzten Dialog und vergrößert keine Schülerzeile. Satzkorrekturen zeigen die vollständige Eingabe und darunter den korrekten Satz; abweichende Zielzeichen sind rot, ohne Durchstreichen. Bei zwei live geprüften Grammatikübergängen war kein manuelles Scrollen zur nächsten Karte erforderlich.
- Aussprachetexte bleiben zusammenhängend und niveaugerecht. Aufnahme und Wiedergabe behalten die Waveform; Schüler und Lehrkraft antworten im selben Text-/Audiodialog. Die vollständige Kette Schüleraufnahme → Lehrer-Sprachantwort → Schülerantwort wurde live mit Wiedergabe geprüft. Aufnahmen bleiben privat. Neue Chat-Nachrichten dürfen durch ältere Datenstände nicht verschwinden; turnusmäßiges Nachladen soll laufende Wiedergabe erhalten. Die Korrektur ist live bestätigt: eine neue Nachricht erschien automatisch nach 10,9 Sekunden.
- Lokale Hörvorbilder dürfen nicht als menschliche Lehreraufnahme ausgegeben werden. Eine Referenzwiedergabe startete im Live-Test mit einem Klick nach 891 ms; dies ist kein garantiertes Zeitbudget für alle Geräte. Die türkische eSpeak-Stimme kann hörbar von den Piper-Stimmen für Deutsch, Englisch, Russisch und Ukrainisch abweichen.
...
Der live geprüfte Bestand umfasst 512 Vokabelkarten, 604 Grammatikübungen, 149 Aussprachetexte mit 60 aktiven Texten sowie zehn aktive und zwei archivierte Kurse. Acht axe-Scans der Auth-Seiten blieben ohne gemeldete Verstöße. Diese begrenzten automatisierten Prüfungen ersetzen keine umfassende Prüfung mit unterschiedlichen Hilfsmitteln und Lernenden.

Der Betrieb nutzt den eigenen VPS [https://217.154.228.254](https://217.154.228.254), geprüftes Let's-Encrypt-IP-TLS und lokale Dienste. Die zuletzt erlaubte lesende Cloud-Orientierung wurde nicht genutzt. Lokale Auth-Mail samt Tokenbestätigung und ein einmaliger Outbox-Worker-Lauf sind nachgewiesen; externe Testmails wurden nicht versendet. Neue Betriebsbehauptungen müssen ihren tatsächlichen Prüfstand nennen. Chat-Bereitstellung und Testkonten-/Audiobereinigung sind abgeschlossen; der regelmäßige Mailworker läuft. [Katalogbestand, ERD, Live-Nachweise und Wiederherstellungsregeln](docs/vps-refactor-2026-09-13.md).
...
- „Gelernt“ bezeichnet beim Vokabeltrainer einen überprüfbaren Softwarestatus: beide Abfragerichtungen nach korrekt abgeschlossener Phase 6. Eine Ersteinstufung „bekannt“ ist kein Abschluss. Fortschritt darf weder dauerhaftes Erinnern noch einen zertifizierten Spracherwerb versprechen. Die bestehende Phase-6-Logik bleibt erhalten und wird vor dem Training verständlich erklärt.
- Grammatik wird in überschaubaren Zehner-Einheiten mit Themenauswahl gelernt. Hilfen, konkrete Rückmeldungen und weitere Versuche erhalten den ruhigen Lernfluss. Aufgaben haben eindeutige Lösungen bzw. explizite Arbeitsanweisungen; die erste Sammlung umfasst 100 Übungen je bestehender Kursstufe A1.1–B1.2. Lehrkräfte können den Bestand erweitern und bearbeiten.
- Aussprache verwendet zusammenhängende Alltagstexte mit steigender sprachlicher Komplexität, zunächst zehn eigene Texte je Kursstufe. Text, Hörvorbild und Aufnahme bilden einen klaren Arbeitsablauf. Die Waveform bleibt für Aufnahme und Wiedergabe bestehen; asynchrones Lehrerfeedback kann als Text oder Sprachnachricht erfolgen und von Lernenden beantwortet werden. Neue Aufnahmen werden ausschließlich im privaten Lernkontext bereitgestellt, ohne öffentliche Veröffentlichung oder automatische Stimmbewertung.
- Alle neuen Bedienelemente folgen den Academy-Farbvariablen, Light-/Darkmode und mindestens 48px großen Touch-Zielen. Schüler- und Verwaltungsansichten bleiben bei schmalen Bildschirmen nutzbar. Neue UI-Texte sind in DE/EN/RU/UK/TR vorhanden; die deutschen Lerninhalte richten sich nach dem jeweiligen Unterrichtsniveau.
- Ein öffentlicher E-Mail-Eintrag ist niemals ein Identitätsnachweis. Übernahme bestehender persönlicher Daten/Kursbuchungen erst nach bestätigter Auth-E-Mail und eindeutiger Zuordnung; gemeinsame E-Mail-Adressen werden nicht geraten. Rechnungskennzeichen sind von Annahme, Versand und Zahlung getrennte Zustände.

Implementierungsdetails und Validierung: [Trainer- und Verwaltungsumbau](docs/trainer-admin-refresh-2026-09-10.md).

> **Kontakt/Impulstakt (2026-09-10):** Anastasias Kontaktaktion öffnet ihren Telegram-Account `@Sprachschule_Anastasia`. Die NeuralBrain-Gruppen erscheinen leicht häufiger, alle 6–8 Sekunden mit weiterhin 1–3 Impulsen und mindestens 2,95 Sekunden vollständiger Ruhe; diese Feinjustierung ersetzt die bisherige Taktvorgabe im folgenden Protokoll.
...
- **Rendering:** Feste Kartenhöhe in `VocabCardSession`, einheitliche Bildslots, keine Skalierung der Folgekarte. Wörter ohne `line-clamp`, damit Unterlängen (g, j, q) nicht abgeschnitten werden. Lektionskarten: Aktions-Buttons untereinander in einer rechten Spalte.
