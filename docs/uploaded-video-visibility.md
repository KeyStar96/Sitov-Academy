...
Produktiv: Release `29f138f0d58a`, VPS-Build einschließlich TypeScript erfolgreich, App/Mail/Nginx aktiv, Health `ready`. Authentifizierte HTTP-Prüfung bestätigt Schüler-Download **403 `download_not_allowed`**, Staff-Download und -Wiedergabe **200**, MP4-Range **206**, zwei Staff-Bedienbuttons. Das vorhandene Alphabet-Video war zum Prüfzeitpunkt inzwischen ausgeblendet: Schüler-Wiedergabe deshalb erwartungsgemäß **403 `not_authorized`**, kein Videoartikel im Schüler-HTML. Diese Einstellung wurde nicht verändert. Schüler-Wiedergabe bei Veröffentlichung und fehlende Download-Schaltflächen sind durch die automatisierten Tests belegt; keine erneute produktive Veröffentlichung nur für die Prüfung. Keine Konten oder Inhalte verändert; kurzlebige Verifikationstokens ausschließlich im Arbeitsspeicher.
