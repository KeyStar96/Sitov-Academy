...
<head>
    ...
    <style>
        ...
        .cta-button { display: inline-block; background-color: #bd3510; color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-weight: 700; font-size: 14px; text-transform: uppercase; letter-spacing: 0.05em; margin-top: 16px; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="text">
                vielen Dank für dein Interesse an unserem Kurs <strong>${courseName}</strong> und an einer Probestunde bei Sitov Academy.
            </p>
            ...
            <p style="text-align: center;">
                <a href="https://www.sitov-academy.com/de#courses" class="cta-button">Kursangebot ansehen</a>
            </p>
        ...
        <div class="footer">
            ...
            const { data: emailData, error: emailError } = await resend.emails.send({
                ...
                to: [trial.email],
                subject: 'Deine Probestunde bei Sitov Academy',
                html: emailHtml,
            })
